...
def test_maintained_implementation_passes_supplied_tester(monkeypatch, capsys) -> None:
    ...
    namespace = {name: getattr(extended_intro_hw2, name) for name in extended_intro_hw2.__all__}
    tester = REPOSITORY_ROOT / "assignment/hw2_tester.py"
